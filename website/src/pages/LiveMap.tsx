...
const KEKE_SVG =
  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="18" r="2.5"/><path d="M3 13h15.5l1.5 5M5 18h14M11 7h5.5L19 13M7 13V7h4M16 7l-1-3H9L8 7"/></svg>'
...
export function LiveMap() {
    ...
    useEffect(() => {
        ...
        // Initial async fetch — the setState calls happen after the await, not
        // synchronously; the loading flag it flips is the intended sync effect.
